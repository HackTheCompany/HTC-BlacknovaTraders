...
$display_password           = true;                            // If true, will display password on signup screen.
...
$adminpass                  = getenv('ADMIN_PASSWORD');                         // The administrator password
$admin_mail                 = getenv('ADMIN_EMAIL');              // The administrator email address
