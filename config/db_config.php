...
$dsn = getenv('CLEARDB_DATABASE_URL'); // 'mysql://'.$username.':'.$password.'@'.$server.'/'.$db;
$databaseurl_pieces = parse_url($dsn);
...
$ADODB_SESSION_CONNECT = $databaseurl_pieces['host'];

// Username and password to connect to the database:
$ADODB_SESSION_USER = $databaseurl_pieces['user'];
$ADODB_SESSION_PWD = $databaseurl_pieces['pass'];

// Name of the SQL database:
$ADODB_SESSION_DB = substr($databaseurl_pieces['path'], 1);
